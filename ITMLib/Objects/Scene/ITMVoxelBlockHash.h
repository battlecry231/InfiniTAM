...
#define SDF_LOCAL_BLOCK_NUM 0xF0000		//0x40000 	// Number of locally stored blocks, currently 2^17

#define SDF_BUCKET_NUM 0x400000			//0x100000	// Number of Hash Bucket, should be 2^n and bigger than SDF_LOCAL_BLOCK_NUM, SDF_HASH_MASK = SDF_BUCKET_NUM - 1
#define SDF_HASH_MASK 0x3fffff			//0xfffff	// Used for get hashing value of the bucket index,  SDF_HASH_MASK = SDF_BUCKET_NUM - 1
